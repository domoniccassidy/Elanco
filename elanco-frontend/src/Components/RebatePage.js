...
const RebatePage = () => {
  ...
  const onGeneratePDF = () =>{
    ...
    document.text(105, 45, 'Rebate Summary',{baseline:"middle",align:"center"});
    document.setFontSize(18)
    document.text(0, 70, `Pet Name: ${userForm.pets[userForm.pet].name}`,{align:"left"});
    document.text(0, 80, `Clinic: ${purchaseForm.clinicName}`,{align:"left"});
    document.text(0, 90, `Address: ${purchaseForm.clinicAddress}`,{align:"left"});
    document.text(0, 100, `State: ${purchaseForm.clinicState}`,{align:"left"});
    ...
    document.autoTable({
      ...
      body: 
        products.map(e =>{
          ...
          return[e.productName,e.rebateValue[e.chosenProduct][0],"$" + e.rebateValue[e.chosenProduct][1]]
        })
        // ...
      ,
    })
    document.text(0, 130 + products.length * 10, `Total Rebate Value: $${totalRebate}`,{align:"left"});
